...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomrule=.15mm, rightrule=.15mm, opacityback=0, breakable, leftrule=.75mm, toptitle=1mm, coltitle=black, left=2mm, bottomtitle=1mm, colback=white, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Comparison of Software}, arc=.35mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, bottomrule=.15mm, rightrule=.15mm, opacityback=0, breakable, leftrule=.75mm, toptitle=1mm, coltitle=black, left=2mm, bottomtitle=1mm, colback=white, titlerule=0mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Order of Variables}, arc=.35mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-caution-color!10!white, colframe=quarto-callout-caution-color-frame]
