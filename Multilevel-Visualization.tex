...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Dataset}, toprule=.15mm, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, bottomtitle=1mm, arc=.35mm, left=2mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, toptitle=1mm]
