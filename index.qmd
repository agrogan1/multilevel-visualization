...
Below, I describe the use of [Stata](https://www.stata.com/) [@StataCorp2021:3], [R](https://www.r-project.org/)[^ggplot2] [@RProgram], and [Julia](https://www.julialang.org/) [@JuliaArticle] to visualize multilevel models. 
